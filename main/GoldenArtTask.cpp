...
// the LEDs are wired (addressed) in an order conducive for board/trace layout.
...
std::array<uint8_t, 89> constexpr rim89 {
...
std::array<uint8_t, 55> constexpr rim55 {
...
std::array<uint8_t, 34> constexpr rim34 {
     0, 13, 26,  5, 18, 31, 10, 23,  2, 15, 28,  7, 20, 33, 12, 25,
     4, 17, 30,  9, 22,  1, 14, 27,  6, 19, 32, 11, 24,  3, 16, 29,
     8, 21,
};
std::array<uint8_t, 21> constexpr rim21 {
     0, 13,  5, 18, 10,  2, 15,  7, 20, 12,  4, 17,  9,  1, 14,  6,
    19, 11,  3, 16,  8,
};
std::array<uint8_t, 13> constexpr rim13 {
    0,  5, 10,  2,  7, 12,  4,  9,  1,  6, 11,  3,  8,
};
std::array<uint8_t, 8> constexpr rim8 {
    0, 5, 2, 7, 4, 1, 6, 3,
};
std::array<uint8_t, 5> constexpr rim5 {
    0, 2, 4, 1, 3,
};
std::array<uint8_t, 3> constexpr rim3 {
    0, 2, 1,
};
std::array<uint8_t, 3> constexpr rim2 {
    0, 1,
};
...
void GoldenArtTask::update_() {
	...
	return LEDI(
	    ...
	    max * perlinNoise[1].octaveNoise0_1(x, t, octaves),
	    max * perlinNoise[2].octaveNoise0_1(x, t, octaves)
    );}()};
