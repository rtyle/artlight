...
else ifeq 'golden' '${ArtLightApplication}'
	CPPFLAGS += -DArtLightApplication_h=\"ArtLightGolden.h\"
else ifeq 'nixie' '${ArtLightApplication}'
	CPPFLAGS += -DArtLightApplication_h=\"ArtLightNixie.h\"
endif
